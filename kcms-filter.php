<?php
/*
Plugin Name: KCMS Filter
Plugin URI: https://github.com/KubeeCMS/kcms-filter/
Description: XforWooCommerce Themes and Plugins! Visit https://github.com/KubeeCMS/
Author: KubeeCMS
...
$GLOBALS['svx'] = isset( $GLOBALS['svx'] ) && version_compare( $GLOBALS['svx'], '1.6.0') == 1 ? $GLOBALS['svx'] : '1.6.0';

if ( !class_exists( 'XforWC_Product_Filters' ) ) :

	final class XforWC_Product_Filters {

		public static $version = '8.2.0';
